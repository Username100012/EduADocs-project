...
from utils.language_manager import get_language_manager, i18n
...
def display_language_selector() -> None:
    ...
    st.markdown("---")
    st.subheader(i18n("language_selector.header", "🌐 Language / Idioma"))
    
    selected_lang_name = st.selectbox(
        i18n("language_selector.label", "Select Language"),
        lang_display_names,
